...
export const ProfileInfo__BD = styled.div`
    display: flex;
    flex-direction: column;
...
export const Profile__BD = styled.div`
    width: 100%;
    display: flex;
    flex-direction: row;
`

export const ProfileAddOn__BD = styled.div`
    width: 100%;
    display: flex;
    flex-direction: row;
...
export const Link__BD = styled.div`
    padding-right: 29.33px;
    `
export const Footer__BD = styled.div`
    width: 1200px;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
export const Button_BD = styled.button`
    width: 180px;
    height: 45px;
    border: 1px solid #bdbdbd;
